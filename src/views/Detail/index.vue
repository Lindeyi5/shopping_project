        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a @click="goodsCartListChange">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      // isCheckedd: spuSaleAttrList
      skuNum: 1
    }
  },
  methods: {
    changeActive(arrval, arr11) {
      arr11.forEach((item) => {
        item.isChecked = 0
      })
      arrval.isChecked = 1
    ...
    changeSkunum() {
      ...
      if (strr1.test(this.skuNum) === false) this.skuNum = 1
    },
    async goodsCartListChange() {
      try {
        let result = await this.$store.dispatch('goodsCartList', {
